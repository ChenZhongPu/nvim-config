...
% tighten the title block generated from YAML title/author/date metadata.
\usepackage{titling}
...
\usepackage{hyperref}
\definecolor{MarkdownUrlColor}{HTML}{005EA8}
\AtBeginDocument{
  \let\MarkdownOriginalHref\href
  \renewcommand{\href}[2]{\MarkdownOriginalHref{#1}{\textcolor{MarkdownUrlColor}{#2}}}
  \let\MarkdownOriginalUrl\url
  \renewcommand{\url}[1]{\textcolor{MarkdownUrlColor}{\MarkdownOriginalUrl{#1}}}
}
